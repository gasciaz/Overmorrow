  ...
  return Padding(
    ...
    child: Container(
      ...
      child: Row(
        children: [
          comfortatext(
            AppLocalizations.of(context)!.mainPollutant,
            18,
            data.settings,
            color: palette.onSecondaryContainer,
          ),
      ...
      child: Column(
        children: [
          pollenWidget(
            ...
            AppLocalizations.of(context)!.alderPollen,
            extendedAqi.alder,
            data,
            palette,
          ),
          pollenWidget(
            Icons.eco_outlined,
            AppLocalizations.of(context)!.birchPollen,
            extendedAqi.birch,
            data,
            palette,
          ),
          pollenWidget(
            ...
            AppLocalizations.of(context)!.grassPollen,
            extendedAqi.grass,
            data,
            palette,
          ),
          pollenWidget(
            ...
            AppLocalizations.of(context)!.mugwortPollen,
            extendedAqi.mugwort,
            data,
            palette,
          ),
          pollenWidget(
            Icons.park_outlined,
            AppLocalizations.of(context)!.olivePollen,
            extendedAqi.olive,
            data,
            palette,
          ),
          pollenWidget(
            ...
            AppLocalizations.of(context)!.ragweedPollen,
            extendedAqi.ragweed,
            data,
            palette,
          ),
          ...
          child: Padding(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  comfortatext(
                    AppLocalizations.of(context)!.europeanAqi,
                    14,
                    data.settings,
                    color: palette.onSurface,
                  ),
                  const Spacer(),
                  comfortatext(
                    extendedAqi.europeanAqi.toString(),
                    25,
                    data.settings,
                    color: palette.primary,
                  ),
          ...
          child: Padding(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  comfortatext(
                    AppLocalizations.of(context)!.unitedStatesAqi,
                    14,
                    data.settings,
                    color: palette.onSurface,
                  ),
    ...
    children: [
      Padding(
        ...
        child: Align(
          ...
          child: comfortatext(
            AppLocalizations.of(context)!.dailyAqi,
            17,
            data.settings,
            color: palette.onSurface,
          ),
                  ...
                  child: Align(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        color: extendedAqi.dailyAqi[index] == highestAqi
                            ? palette.secondary
                            : palette.secondaryContainer,
                      ),
                      width: 48,
                      ...
                      height: max(
                        130 / max(highestAqi, 1) * extendedAqi.dailyAqi[index],
                        48,
                      ),
                      child: comfortatext(
                  ...
                  Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: comfortatext(
                          AppLocalizations.of(context)!.dust,
                          14,
                          data.settings,
                          color: palette.onSurface,
                        ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Padding(
                          padding: const EdgeInsets.only(left: 5),
                          child: comfortatext(
                            AppLocalizations.of(context)!.aerosolOpticalDepth,
                            14,
                            data.settings,
                            color: palette.onSurface,
                          ),
              ...
              child: Column(
                ...
                children: List.generate(len, (index) {
                  return Row(
                    ...
                    children: [
                      comfortatext(
                        chartTypes[currentChart][len - 1 - index].toString(),
                        14,
                        data.settings,
                        color: palette.outline,
                      ),
