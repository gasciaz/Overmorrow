                    ...
                    children: [
                      Center(
                        child: Container(
                          ...
                          child: Icon(
                            OvermorrowWeatherIcons3.partly_cloudy,
                            size: 100,
                            color: palette.primary,
                          ),
                        ),
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            comfortatext(
                              AppLocalizations.of(context)!.versionUppercase,
                              18,
                              settings,
                              color: palette.onSurface,
                            ),
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              comfortatext(
                                AppLocalizations.of(context)!.apiAndServices,
                                18,
                                settings,
                                color: palette.onSurface,
                              ),
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            comfortatext(
                              AppLocalizations.of(context)!.licenseUppercase,
                              18,
                              settings,
                              color: palette.onSurface,
                            ),
                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        comfortatext(
                          AppLocalizations.of(context)!.weatherDataLowercase,
                          20,
                          settings,
                          color: palette.onSurface,
                        ),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        comfortatext(
                          AppLocalizations.of(context)!.radar,
                          20,
                          settings,
                          color: palette.onSurface,
                        ),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        comfortatext(
                          AppLocalizations.of(context)!.imagesLowercase,
                          20,
                          settings,
                          color: palette.onSurface,
                        ),
